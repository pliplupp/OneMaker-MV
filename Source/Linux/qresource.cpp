...
void _onemaker_initialize() {
    ...
    #ifdef Q_OS_MAC
    dest = QStandardPaths::writableLocation(QStandardPaths::HomeLocation) + "/Library/Application Support/Steam/steamapps/common/RPG Maker MV/RPG Maker MV.app/Contents/MacOS"; // This only works on Steam, currently. 
    #endif
